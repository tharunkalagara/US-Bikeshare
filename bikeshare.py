...
def get_filters():
    ...
    while 1 == 1 :
        city = input("\nenter the name of the city to analyze city names are as follows chicago,new york,washington. \n").lower()
...
def more_data(df):
    user_input = input('Do you want to see more data? Enter yes or no.\n')
    line_number = 0
